...
_PROMPT_DEFAULT = (
    ...
    "   Debe explicar beneficios reales del producto, resolver una necesidad del cliente "
    ...
    "6. Si la categoría es '- Sin Departamento -', dedúcela por el nombre o descripción del producto.\n\n"
